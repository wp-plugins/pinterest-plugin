=== Pinterest Plugin ===
Contributors: successnexus.com
Donate link: http://successnexus.com/buy-us-a-beer/
Tags: Pinterest, Pin it
...
* [Science of Using Pictures on Your Blog to Persuade People](http://successnexus.com/science-pictures-persuade/)
* [Help & Support](http://SuccessNexus.com/support/)

== Installation ==

1. Upload the `Pinterest` folder to the `/wp-content/plugins/` directory
1. Activate the Pinterest Plugin through the 'Plugins' menu in WordPress
1. Optional step: Integrate Pinterest with SuccessNexus.com affiliate program by going to the `Pinterest Plugin` link that appears under 'Settings'
